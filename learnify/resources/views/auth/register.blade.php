...
<head>
    ...
    <style>
        ...
        /* Column Styling */
        /* Perubahan untuk Register: Membuat kolom Card lebih lebar di tengah */
        .col-xl-4 {
            flex: 0 0 50%; 
            max-width: 60%; 
            padding: 0 200px;
        ...
        .card-body {
            flex: 1 1 auto;
            padding: 2.0rem 2.0rem; /* Ditingkatkan untuk spacing */
        }
        ...
        .mb-3 {
            margin-bottom: 1.5rem !important; /* Ditingkatkan untuk spacing */
        }
        ...
        /* Card Footer */
        .card-footer {
            padding: 0 2.0rem 2.0rem; /* Ditingkatkan untuk spacing */
            background-color: #fff;
            border-top: 0;
        }
        ...
        /* Oblique Image Section (Right Side) */
        .oblique {
